...
--
-- Host: localhost:3306
-- Generation Time: Jan 30, 2023 at 06:59 AM
...
INSERT INTO `tb_history` (`kode_history`, `nama`, `kode_solusi`) VALUES
(20, 'Agan', 's-1a'),
(21, 'Agan', 's-1a'),
(22, 'Agan', 's-3b'),
(23, 'Agan', 'x-1');
...
--
ALTER TABLE `tb_history`
  MODIFY `kode_history` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
