...
--
-- Host: localhost:3306
-- Generation Time: Jan 30, 2023 at 05:47 AM
...
INSERT INTO `tb_history` (`kode_history`, `isi_pertanyaan`, `isi_solusi`) VALUES
(1, '', ''),
(2, '', ''),
(3, '', 'Informatika'),
(4, '', ''),
...
--
ALTER TABLE `tb_history`
  MODIFY `kode_history` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tb_kesimpulan`
--
ALTER TABLE `tb_kesimpulan`
  MODIFY `kode_kesimpulan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
COMMIT;
